var words = [
    {number:1,direction:'across',row:1,column:4,clue:'IMAGINAR',answer:'imagination',hint:'https://www.youtube.com/watch?v=NE6pANWJGuU'},
    {number:2,direction:'down',row:1,column:7,clue:'LOS PAPÁS DE TUS PAPÁS',answer:'GRANDPARENTS',hint:'https://www.youtube.com/watch?v=vNCroWI3uPM'},
    {number:3,direction:'down',row:1,column:17,clue:'POLLO',answer:'CHICKEN',hint:'https://www.youtube.com/watch?v=oKqIFhQreKM'},
    {number:4,direction:'across',row:4,column:10,clue:'ELECTRICO',answer:'ELECTRIC',hint:'https://www.youtube.com/watch?v=ojpTpT5i-PI'},
    {number:5,direction:'down',row:5,column:24,clue:'OSCURO',answer:'DARK',hint:'https://www.youtube.com/watch?v=2LJjtyNnOWc'},
    {number:6,direction:'down',row:3,column:2,clue:'DESAYUNAR',answer:'BREAKFASTING',hint:'https://www.youtube.com/watch?v=qYQABJXHfpE'},
    {number:7,direction:'across',row:5,column:17,clue:'TECLADO',answer:'KEYBOARD',hint:'https://www.intechopen.com/chapters/79135'},
    {number:8,direction:'down',row:5,column:20,clue:'FORMA CARIÑOSA DE DECIR HERMANO',answer:'BRO',hint:'https://www.youtube.com/watch?v=6Cp6mKbRTQY'},
    {number:9,direction:'down',row:5,column:22,clue:'DEPARTAMENTO',answer:'APARTMENT',hint:'https://www.youtube.com/watch?v=wZaqviDdFYU'},
    {number:10,direction:'across',row:6,column:2,clue:'ACOMPAÑAMIENTO',answer:'ACCOMPANIMENT',hint:'https://www.youtube.com/watch?v=aiXMvMj9gmc'},
    {number:11,direction:'across',row:12,column:7,clue:'PIEDRA',answer:'STONE',hint:'https://www.youtube.com/watch?v=7QU1nvuxaMA'},
    {number:12,direction:'down',row:12,column:9,clue:'ORGANIZACIÓN',answer:'ORGANIZATION',hint:'https://www.youtube.com/watch?v=HfHLKGpcxsE'},
    {number:13,direction:'across',row:13,column:16,clue:'LITERATURA',answer:'LITERATURE',hint:'noon'},
    {number:14,direction:'down',row:17,column:16,clue:'TELÉFONO',answer:'TELEPHONE',hint:'https://www.youtube.com/watch?v=y7B6Z-_-Bcc'},
    {number:15,direction:'across',row:17,column:9,clue:'INFORMACIÓN',answer:'INFORMATION',hint:'https://www.youtube.com/watch?v=XD4b0fSuB6c'},
    {number:16,direction:'across',row:20,column:12,clue:'CENTRO DE MESA',answer:'CENTERPIECE',hint:'https://www.youtube.com/watch?v=16d6XiCDESI'},
    {number:17,direction:'across',row:22,column:7,clue:'SUELO',answer:'FLOOR',hint:'https://www.youtube.com/watch?v=v4pi1LxuDHc'},
    {number:18,direction:'down',row:24,column:19,clue:'ASOMBROSO',answer:'AWESOME',hint:'noon'},
    {number:19,direction:'across',row:24,column:15,clue:'INSTANCIA',answer:'INSTANCE',hint:'noon'},
    {number:20,direction:'down',row:24,column:22,clue:'ENTRETENER',answer:'ENTERTAIN',hint:'https://www.youtube.com/watch?v=qijlMxWnDdM'},
];

// Set global variables
var gridSize = [25,32];     // number of squares wide, number of squares tall
...
var $resetButton = $('<button class="btn btn-default">REINICIAR</button>');
